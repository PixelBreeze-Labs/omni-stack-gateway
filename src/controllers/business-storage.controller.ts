// src/controllers/business-storage.controller.ts
import { 
    Controller, 
    Post, 
    Get, 
  ...
  export class BusinessStorageController {
    ...
    async deleteFile(
      ...
      try {
        ...
        const result = await this.businessStorageService.deleteFile(businessId, fileName);
    ...
    async bulkDeleteFiles(
      ...
      try {
        ...
        const result = await this.businessStorageService.bulkDeleteFiles(businessId, body.fileNames);
    ...
    /**
     * Validate business API key and return business document
     */
